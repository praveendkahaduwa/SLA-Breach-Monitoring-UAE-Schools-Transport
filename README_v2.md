# Hafilati SLA Intelligence Platform
### Emirates Transport · MOE School Bus Operations · UAE · 2026
...
Emirates Transport operates MOE school bus routes across the UAE under strict SLA agreements:
...
```
Oracle ADW (Hafilati source system)
        │
        ▼
...
| Layer | Technology |
|---|---|
| Source system | Oracle ADW (Emirates Transport Hafilati) |
...
### Power BI
```
1. Open Hafilati_SLA_Monitor.pbix
...
```
hafilati-sla-intelligence/
├── README.md
├── hafilati_pipeline.py           # AI + traffic pipeline
├── hafilati_breach_narratives.py  # Standalone AI narrative generator
├── hafilati_traffic_correlation.py# Traffic API + correlation analysis
├── sample_data/
...
│   └── Notes_Page.dax
└── mockup/
    └── hafilati_v4_mockup.html    # Interactive dashboard preview
```
...
*Emirates Transport · Hafilati 2026 · For demonstration purposes*
